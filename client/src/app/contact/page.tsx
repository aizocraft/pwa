  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await submitContact({
        ...
        subject: serviceOptions.find(opt => opt.value === formData.subject)?.label || formData.subject,
            ...
            >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="space-y-1">
                        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
                          Hurlingum Shopping Square,<br />
                          Opposite Total Energies Chokaa,<br />
              ...
              <div className="grid sm:grid-cols-2 gap-6 mb-6">
                ...
                <div className="group bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">Call Us</h3>
                ...
                <div className="group bg-white dark:bg-gray-900 rounded-2xl p-6 border border-gray-200 dark:border-gray-800 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-3">Email</h3>
                  <motion.a
