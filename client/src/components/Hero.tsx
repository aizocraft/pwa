...
>
  <div className="bg-white/30 backdrop-blur-md rounded-2xl p-6 sm:p-8 shadow-xl border border-white/50">
    <ShinyText 
      ...
      disabled={false} 
      speed={4} 
      className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed font-medium text-center text-black" 
    />
  </div>
</motion.div>
...
<motion.div 
  ...
  className="flex flex-wrap gap-4 justify-center mb-12 sm:mb-16 md:mb-20"
>
  ...
  <Link href="/products">
    <motion.button 
      ...
      whileTap={{ scale: 0.98 }}
      className="group relative px-7 sm:px-9 py-3.5 sm:py-4.5 bg-[#1e3a8a] text-white font-semibold text-sm sm:text-base rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden"
    >
  ...
  <Link href="/about">
    <motion.button 
      whileHover={{ scale: 1.05 }}
      whileTap={{ scale: 0.98 }}
      className="relative px-7 sm:px-9 py-3.5 sm:py-4.5 font-semibold text-sm sm:text-base rounded-full transition-all duration-300 group"
    >
...
<motion.div 
  ...
  className="flex flex-wrap justify-center gap-8 sm:gap-12 md:gap-16 max-w-3xl mx-auto w-full px-2"
>
  {/* Boreholes */}
  <motion.div
    initial={{ opacity: 0, y: 20 }}
  ...
  >
    ...
    <div className="text-xs sm:text-sm text-white/60 mt-2">Boreholes</div>
  </motion.div>
  ...
  >
    ...
    <div className="text-xs sm:text-sm text-white/60 mt-2">Solar Projects</div>
  </motion.div>
  ...
  >
    ...
    <div className="text-xs sm:text-sm text-white/60 mt-2">Satisfaction</div>
  </motion.div>
</motion.div>
          </div>
        </div>
...
<div className="absolute -bottom-1 left-0 right-0 z-10 leading-none pointer-events-none">
  <svg viewBox="0 0 1440 70" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
    ...
    />
        ...
        <motion.div 
          ...
          className="absolute bottom-16 sm:bottom-12 left-1/2 transform -translate-x-1/2 cursor-pointer z-20 hidden sm:block"
