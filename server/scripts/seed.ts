  ...
  try {
    ...
    const productsData = [
      // ===== GENERATOR =====
      {
        ...
        stock: 10,
        images: [
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1775035152/dc1_njza16.jpg',
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1775035077/dc2_rbbsin.jpg',
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1775034987/dc3_rbvnvl.jpg'
        ],
        featured: true,
        rating: 4.7,
      ...
      // ===== SECOND GENERATOR =====
      {
        ...
        stock: 15,
        images: [
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1742330765/Products/srqnvt7iy2vkwu6hikii.jpg',
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1742230190/Avatar/vljcqyv7tqm40tqgzfin.jpg'
        ],
        rating: 4.5,
      ...
      // ===== PUMP =====
      {
        ...
        stock: 20,
        images: [
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1742328845/Products/nqklmruanqlspsbxw8v2.jpg'
        ],
        rating: 4.4,
        tags: ['pump', 'water']
      },
      ...
      // ===== SOLAR PANEL =====
      {
        ...
        stock: 50,
        images: [
          'https://res.cloudinary.com/duxnsu61a/image/upload/v1775047621/410_Q-PEAK-DUO-BLK-G10-All-Black-Solar-Panel_600x600_facado.webp'
        ],
        featured: true,
        rating: 4.8,
        tags: ['solar', 'panel']
      ...
      // ===== INVERTER =====
      {
        ...
        stock: 12,
        images: [
          'https://images.unsplash.com/photo-1581091870627-3c6a8b5f9c3d?w=400'
        ],
        rating: 4.6,
        tags: ['inverter', 'solar']
      },
      ...
      // ===== BATTERY =====
      {
        ...
        stock: 25,
        images: [
          'https://images.unsplash.com/photo-1602526217033-4c9e0b2e8e9b?w=400'
        ],
        rating: 4.5,
        tags: ['battery']
      },
      ...
      // ===== EXTRA PRODUCT 1 =====
      {
        ...
        stock: 7,
        images: [
          'https://images.unsplash.com/photo-1611259188334-2c3d6c7bdbd3?w=400'
        ],
        rating: 4.9,
